...
import {addphoto,avatar1,avatar1pressed,
...
avatar10,avatar10pressed,} from '../../assets/icons';
...
return(
  <ImageBackground
    ...
    <StudentItem source={this.state.pickedImage} label={'Ahmed'} onPress={this.pickImageHandler.bind(this)}/>
    </View>
    <View style={styles.avatarContainer}>
    <View style={{flexDirection: 'row'}}>
    {this.state.avatarline1.map((avatar, i) => (
    <AvatarItem key={i} source={avatar.source} onPress={()=>{
